const messages = {
	es: {
		translations: {
			...
			contactList: {
				dialog: "Lista guardada satisfactoriamente."
			},
			queueModal: {
				title: {
					add: "Agregar cola",
			...
			userModal: {
				...
				form: {
					...
					password: "Contraseña",
					profile: "Perfil",
					campaignEnable: "Habilitar Campañas?",
					maxCampaigns: "Max Campañas",
					maxContactsPerCampaign: "Max contactos/campaña",
				},
				buttons: {
					okAdd: "Agregar",
					okEdit: "Guardar",
        ...
        dialog: {
          new: "Nueva Campaña de {{name}}",
          update: "Editar Campaña de {{name}}",
          readonly: "Campaña solo lectura de {{name}}",
          form: {
						queue: "Linha",
            name: "Nombre",
						maxCampaigns: "Max Campañas",
          ...
          buttons: {
            ...
            edit: "Update",
            okadd: "Ok",
            cancel: "Cancel Sendings",
            restart: "Restart Sendings",
            close: "Close",
            attach: "Import File",
          },
        },
        ...
        toasts: {
          success: "Operation sucessfully completed",
          ...
          deleted: "Campaign Deleted",
			...
			backendErrors: {
				...
				ERR_CAMPAIGN_CREATION_MAX_LIMIT:
					"Ha alcanzado el límite máximo para la creación de campañas.",
				ERR_CAMPAIGN_CREATION_MAX_LIMIT_CONTACTS:
					"Ha alcanzado el límite máximo de contactos para la creación da campaña.",
          ...
          "Faltan datos obligatorios a rellenar en la campaña."
			},
		},
	},
};
